...
def load_tile_images(folder):
    ...
    return np.array(images), np.array(tile_labels), np.array(crown_labels), crown_positions
...
def main():
    ...
    images, tile_labels, crown_labels, crown_positions = load_tile_images(TILES_FOLDER)
